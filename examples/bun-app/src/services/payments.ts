...
export function processGateway(
	validationResult: PaymentsValidateEligibilityResult | undefined,
): PaymentsProcessGatewayResult {
	...
	const refundAmount = validationResult.refund_amount;
...
export function updateRecords(
	refundResult: PaymentsProcessGatewayResult | undefined,
): PaymentsUpdateRecordsResult {
	...
	const paymentId = refundResult.payment_id;
	const refundId = refundResult.refund_id;
...
export function notifyCustomer(
	...
	const refundId = refundResult.refund_id;
	const refundAmount = refundResult.refund_amount;
